...
function Home() {
  return (
    <div className="bg-[#FFF6E5] flex-1 flex flex-col">
      <div className="flex flex-col leading-none">
        ...
        <p className="text-center self-center leading-5 font-light text-[0.8rem] w-2/5">
          ...
          and healthy. Pawmart is your one-stop shop for all things pet-related.
          Shop with us for the best care for your furry friends!
        </p>
      </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-row space-x-2 items-center">
              ...
              <div className="flex flex-col">
                <span className="text-[0.6rem] font-semibold">Dave Malik</span>
